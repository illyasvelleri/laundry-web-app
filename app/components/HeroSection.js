...
export default function LaundryHero() {
  ...
  const circlePositions = [
    { width: '54px', height: '65px', left: '23%', top: '75%' },
    { width: '115px', height: '110px', left: '35%', top: '16%' },
    { width: '113px', height: '70px', left: '20%', top: '53%' },
    { width: '56px', height: '75px', left: '58%', top: '49%' },
    { width: '108px', height: '52px', left: '3%', top: '1%' },
  ];
  ...
  return (
    <div className="overflow-hidden w-full min-h-screen bg-gradient-to-br from-blue-50 via-white to-cyan-50 relative">
      ...
      <section
        ref={containerRef}
        className="min-h-screen flex flex-col items-center relative z-10 px-6 lg:px-16 xl:px-20 pb-20 md:pb-0"
      >
        <Header cart={[]} />
