...
// import { Shirt, Shield, Zap, Star, ShoppingCart, Phone, MapPin, Clock, Truck, Plus, Minus, Building, Home } from 'lucide-react';
...
//                     className="relative bg-gradient-to-r from-blue-600 to-cyan-600 text-white px-4 py-2 rounded-full flex items-center space-x-2 hover:from-blue-700 hover:to-cyan-700 transition-all duration-300 shadow-lg hover:shadow-xl"
//                   >
...
import { motion } from 'framer-motion';
import { ShoppingCart, Phone, MapPin, Clock, Truck, Plus, Minus, Building, Home } from 'lucide-react';
